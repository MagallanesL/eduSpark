...
const positiveFeedbackMessages = [
  "¡Excelente! Tu chispa acaba de crecer.",
  "¡Una chispa más recuperada!",
  "¡Excelente! Tu chispa acaba de crecer.",
  "¡Una chispa más recuperada!"
];
...
function renderMathQuestion() {
  ...
  mathQuestionHost.innerHTML = `
    ...
    <sparky-dialog
      class="mission-sparky-dialog"
      state="start"
      message="Esta misión necesita observación. Vamos paso a paso."
    ></sparky-dialog>
...
function checkMathAnswer(answer) {
  ...
  if (answer === question.correctAnswer) {
    ...
    if (typeof window.showRewardModal !== "function") showSharedAlert({
      ...
      text: "¡Excelente! Tu chispa acaba de crecer."
    });
    stopCamera();
  ...
  mathFeedback.textContent = "No pasa nada. Pensar también es parte del juego.";
  ...
  showSharedAlert({
    ...
    emoji: "⚪",
    title: "Casi",
    text: "No pasa nada. Pensar también es parte del juego."
  });
}
...
function completeMathChallenge() {
  ...
  if (mathQuestionHost) {
    mathQuestionHost.innerHTML = `
      ...
      <sparky-dialog
        class="mission-sparky-dialog"
        state="complete"
        message="¡Una chispa más recuperada!"
      ></sparky-dialog>
  ...
  if (window.eduSparkSound?.isEnabled()) {
    window.eduSparkSound.play("complete");
  }
...
async function startCamera() {
  try {
    ...
    showSparkyState("hint", "cameraSparkyDialog");
...
function handlePrediction(className, probability) {
  ...
  hideHintCard();
  if (hintResult.status === "not_allowed") {
    showSparkyState("cameraMiss", "cameraSparkyDialog");
  }
...
function showSparkyState(state, targetId = "sparkyGlobalDialog") {
